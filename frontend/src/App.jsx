...
function App() {
  ...
  const isIntermediary =
    account && INTERMEDIARY_ADDRESS &&
    account.toLowerCase() === INTERMEDIARY_ADDRESS.toLowerCase();
    ...
    <div className="app-layout">
      <aside className="app-sidebar">
        ...
        <nav className="sidebar-nav">
          <button className={`nav-item ${activeTab === 'ozet' ? 'active' : ''}`} onClick={() => setActiveTab('ozet')}>Özet</button>
          <button className={`nav-item ${activeTab === 'ceklerim' ? 'active' : ''}`} onClick={() => setActiveTab('ceklerim')}>Çeklerim</button>
          <button className={`nav-item ${activeTab === 'olustur' ? 'active' : ''}`} onClick={() => setActiveTab('olustur')}>Çek Oluştur</button>
          <button className={`nav-item ${activeTab === 'alacaklarim' ? 'active' : ''}`} onClick={() => setActiveTab('alacaklarim')}>Alacaklarım</button>
          {isIntermediary && (
            <button className={`nav-item ${activeTab === 'araci' ? 'active' : ''}`} onClick={() => setActiveTab('araci')}>Aracı Kurum Paneli</button>
          )}
        </nav>
